 ...
 */
class DoubleParamEntity extends \CertificatesModule\Models\Param\DoubleParamEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DoubleParamEntity $proxy) {
