 ...
 */
class TextParamEntity extends \CertificatesModule\Models\Param\TextParamEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextParamEntity $proxy) {
