...
namespace Kdyby\GeneratedProxy\__CG__\CertificatesModule\Models\Certificate;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CertificateEntity extends \CertificatesModule\Models\Certificate\CertificateEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CertificateEntity $proxy) {
    ...
    public function getFullCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFullCode', array());

        return parent::getFullCode();
    }
