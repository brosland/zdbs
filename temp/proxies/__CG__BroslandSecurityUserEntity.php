...
namespace Kdyby\GeneratedProxy\__CG__\Brosland\Security;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class UserEntity extends \Brosland\Security\UserEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'surname', 'email', 'password', 'registered', 'lastLog', 'roles', 'id');
        }
     ...
     * {@inheritDoc}
     */
    public function setLastLog(\Nette\DateTime $lastLog)
    {
