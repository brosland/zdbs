 ...
 */
class StringParamEntity extends \CertificatesModule\Models\Param\StringParamEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StringParamEntity $proxy) {
