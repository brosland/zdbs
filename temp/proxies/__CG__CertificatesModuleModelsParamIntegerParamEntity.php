 ...
 */
class IntegerParamEntity extends \CertificatesModule\Models\Param\IntegerParamEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IntegerParamEntity $proxy) {
