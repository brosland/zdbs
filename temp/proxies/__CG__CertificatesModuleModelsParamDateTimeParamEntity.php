 ...
 */
class DateTimeParamEntity extends \CertificatesModule\Models\Param\DateTimeParamEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DateTimeParamEntity $proxy) {
